...
public abstract class DictionaryDescriptionController implements HttpRequest.Callbacks {

    protected Activity activity; // The main activity.
    protected ProgressDialog progressDialog; // Progress dialog.
    protected EditText etDesc, etExample;

    // ctor:
    public DictionaryDescriptionController(Activity activity) {
        this.activity = activity;

        etDesc = (EditText) activity.findViewById(R.id.editTextDescription);
        etExample = (EditText) activity.findViewById(R.id.editTextExample);
